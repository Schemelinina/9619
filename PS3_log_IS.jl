...
using Plots
plot(p,x_ext, title="log_monomial")
...
plot(xi,interp, title="log_Newton")
#Extrapolating
plot!(f_ext,x_ext)
...
plot(x,int,label="cubic spline_log")
...
plot!(x_ext,naturalspline_ext,label="cubic spline_log_extrapolation")